...
# Unit tests for Late::PostLogDetail
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Late::PostLogDetail do
  #let(:instance) { Late::PostLogDetail.new }

  describe 'test an instance of PostLogDetail' do
    it 'should create an instance of PostLogDetail' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Late::PostLogDetail)
    end
  end
