...
# Unit tests for Late::PostAnalytics
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Late::PostAnalytics do
  #let(:instance) { Late::PostAnalytics.new }

  describe 'test an instance of PostAnalytics' do
    it 'should create an instance of PostAnalytics' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Late::PostAnalytics)
    end
  end
