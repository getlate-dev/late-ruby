...
# Unit tests for Late::MediaItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Late::MediaItem do
  #let(:instance) { Late::MediaItem.new }

  describe 'test an instance of MediaItem' do
    it 'should create an instance of MediaItem' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Late::MediaItem)
    end
  end
  ...
  describe 'test attribute "tiktok_processed"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
