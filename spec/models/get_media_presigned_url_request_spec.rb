...
# Unit tests for Late::GetMediaPresignedUrlRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Late::GetMediaPresignedUrlRequest do
  #let(:instance) { Late::GetMediaPresignedUrlRequest.new }
  ...
  describe 'test an instance of GetMediaPresignedUrlRequest' do
    it 'should create an instance of GetMediaPresignedUrlRequest' do
      ...
      #expect(instance).to be_instance_of(Late::GetMediaPresignedUrlRequest)
    end
  end
