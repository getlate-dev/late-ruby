...
# Unit tests for Late::AnalyticsListResponsePostsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Late::AnalyticsListResponsePostsInner do
  #let(:instance) { Late::AnalyticsListResponsePostsInner.new }

  describe 'test an instance of AnalyticsListResponsePostsInner' do
    it 'should create an instance of AnalyticsListResponsePostsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Late::AnalyticsListResponsePostsInner)
    end
  end
