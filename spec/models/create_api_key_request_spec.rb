...
# Unit tests for Late::CreateApiKeyRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Late::CreateApiKeyRequest do
  #let(:instance) { Late::CreateApiKeyRequest.new }

  describe 'test an instance of CreateApiKeyRequest' do
    it 'should create an instance of CreateApiKeyRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Late::CreateApiKeyRequest)
    end
  end
