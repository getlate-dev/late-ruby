...
module Late
  class WebhooksApi
    ...
    def get_webhook_logs_with_http_info(opts = {})
      ...
      allowable_values = ["post.scheduled", "post.published", "post.failed", "post.partial", "account.connected", "account.disconnected", "message.received", "comment.received", "webhook.test"]
