...
module Late
  ...
  class WebhookLog < ApiModelBase
    ...
    def valid?
      ...
      event_validator = EnumAttributeValidator.new('String', ["post.scheduled", "post.published", "post.failed", "post.partial", "account.connected", "account.disconnected", "message.received", "webhook.test"])
    ...
    def event=(event)
      validator = EnumAttributeValidator.new('String', ["post.scheduled", "post.published", "post.failed", "post.partial", "account.connected", "account.disconnected", "message.received", "webhook.test"])
