...
module Late
  class PostLogDetail < ApiModelBase
    attr_accessor :_id
    ...
    def self.openapi_types
      {
        :'_id' => :'String',
        :'post_id' => :'PostLogDetailAllOfPostId',
        :'user_id' => :'String',
        :'profile_id' => :'String',
        :'platform' => :'String',
        :'account_id' => :'PostLogDetailAllOfAccountId',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Late::PostLogDetail` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Late::PostLogDetail`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [_id, post_id, user_id, profile_id, platform, account_id, account_username, action, status, status_code, endpoint, request, response, duration_ms, attempt_number, created_at, metadata].hash
    end
